...
train_dir = 'D:/color_train_data/train_data'  # 训练集数据
val_dir = 'D:/color_train_data/validation_data'  # 验证集数据
nb_epoch = 15
batch_size = 32
...
checkpoint = ModelCheckpoint("color_trained_epoch_{epoch}.h5", monitor='val_loss',
